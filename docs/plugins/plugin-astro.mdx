...
The plugin is currently available on the following runtimes (what's possible
depends on which platforms [Astro suports](https://docs.astro.build/en/guides/server-side-rendering/#enabling-ssr-in-your-project)):
